...
const PoolMaster = require('./pool_master.js')
...
r.prototype.js = function (jsString, options) {
  if (Term.prototype._fastArityRange(arguments.length, 1, 2) === false) {
    Term.prototype._arityRange([...arguments], 1, 2, 'r.js', this)
  }
...
r.prototype.literal = function (obj) {
  if (Term.prototype._fastArityRange(arguments.length, 0, 1) === false) {
    Term.prototype._arityRange([...arguments], 1, 2, 'r.literal', this)
  }
  if (obj === undefined) {
...
r.prototype.and = function () {
  ...
  return term.and.apply(term, [...arguments])
}
r.prototype.or = function () {
  var term = new Term(this)
  return term.or.apply(term, [...arguments])
}
...
r.prototype.floor = function (num) {
  if (Term.prototype._fastArity(arguments.length, 1) === false) {
    Term.prototype._arity([...arguments], 1, 'r.floor', this)
  }
  return new Term(this).expr(num).floor()
}
r.prototype.ceil = function (num) {
  if (Term.prototype._fastArity(arguments.length, 1) === false) {
    Term.prototype._arity([...arguments], 1, 'r.ceil', this)
  }
  return new Term(this).expr(num).ceil()
}
r.prototype.round = function (num) {
  if (Term.prototype._fastArity(arguments.length, 1) === false) {
    Term.prototype._arity([...arguments], 1, 'r.round', this)
  }
...
r.prototype.time = function () {
  var term = new Term(this)
  return term.time.apply(term, [...arguments])
}
...
r.prototype.branch = function (predicate, trueBranch, falseBranch) {
  const _args = [...arguments]
  Term.prototype._arityRange([...arguments], 3, Infinity, 'r.branch', this)
...
r.prototype.object = function () {
  var term = new Term(this)
  return term.object.apply(term, [...arguments])
}
r.prototype.args = function () {
  var term = new Term(this)
  return term.args.apply(term, [...arguments])
}
r.prototype.random = function () {
  var term = new Term(this)
  return term.random.apply(term, [...arguments])
}
r.prototype.http = function () {
  var term = new Term(this)
  return term.http.apply(term, [...arguments])
}
...
r.prototype.uuid = function () {
  const _args = [...arguments]
  Term.prototype._arityRange([...arguments], 0, 1, 'r.uuid', this)
  var term = new Term(this)
...
r.prototype.typeOf = function (value) {
  if (Term.prototype._fastArity(arguments.length, 1) === false) {
    Term.prototype._arity([...arguments], 1, 'r.typeOf', this)
  }
  var term = new Term(this)
...
function main (options = {}) {
  ...
  let _r = new r()
  _r._options = {}
  if (!helper.isPlainObject(options)) return _r

  if (cursor === true) _r._options.cursor = true
  if (stream === true) _r._options.stream = true
  if (optionalRun === false) {
  ...
  if (pool === true) _r.createPools(poolOptions)
  return _r
}
